...
const index = () => {
  ...
  const [sapDemandCount, setSapDemandCount] = useState(0);
  const [sageDemandCount, setSageDemandCount] = useState(0);
    ...
    const fetchDemandCounts = async (id) => {
      try {
        if (id) {
          ...
          setSapDemandCount(data.sapDemandCount);
          setSageDemandCount(data.sageDemandCount);
          setTotalDemande(data.totalDemandCount);
        }
      } catch (error) {
       ...
       <div class="w-screen mt-16">
          <div class="mx-auto grid max-w-screen-lg gap-4 p-4 sm:grid-cols-2 lg:grid-cols-3">
            <div class="max-w-md rounded-lg border px-6 pt-6 pb-10">
              ...
              <p class="text-4xl font-medium text-gray-800">{sapDemandCount}</p>
            ...
            <div class="max-w-md rounded-lg border px-6 pt-6 pb-10">
              ...
              <p class="text-4xl font-medium text-gray-800">{sageDemandCount}</p>
            ...
            <div class="max-w-md rounded-lg border px-6 pt-6 pb-10">
              ...
              <p class="text-4xl font-medium text-gray-800">{totaleDemande}</p>
